...
FROM '/home/ishan/Projects/dbt/datasets_raw/customer.csv' DELIMITER ',' CSV HEADER;
COPY warehouse.state(state_identifier, state_code, st_name)
FROM '/home/ishan/Projects/dbt/datasets_raw/state.csv' DELIMITER ',' CSV HEADER;
...
FROM '/home/ishan/Projects/dbt/datasets_raw/orders.csv' DELIMITER ',' CSV HEADER;
